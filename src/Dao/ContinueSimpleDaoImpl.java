...
public class ContinueSimpleDaoImpl implements ContinueSimpleDao {
	...
	private DAOFactory          daoFactory;
	  ...
	  ContinueSimpleDaoImpl( DAOFactory daoFactory ) {
	  ...
	  private static final String[] SQL_SELECT_PORTEE = {"SELECT charge_150 FROM continue_simple WHERE epaisseurX = ? AND epaisseurY= ?",
			  "SELECT charge_250 FROM continue_simple WHERE epaisseurX = ? AND epaisseurY= ?",
			  "SELECT charge_400 FROM continue_simple WHERE epaisseurX = ? AND epaisseurY= ?",
			  "SELECT charge_500 FROM continue_simple WHERE epaisseurX = ? AND epaisseurY= ?",
			  "SELECT charge_150T FROM continue_simple WHERE epaisseurX = ? AND epaisseurY= ?",
			  "SELECT charge_100T FROM continue_simple WHERE epaisseurX = ? AND epaisseurY= ?"};
